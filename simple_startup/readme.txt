...
- i got rid of conda cus its not really necessary i dont think 

- added a 'launch vscode script' thats awesome 

- added a stream output script thats pretty helpful 

- added a sync command to download the /output dir. 

T0d0 
- need a way to update files on remote based on hashes of local machine 
- need to implement the choline ignore stuff 
- need to turn into a package and launch on pypi 
